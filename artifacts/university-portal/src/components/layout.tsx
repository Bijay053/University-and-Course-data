...
import { LayoutDashboard, Building2, HardDrive, UploadCloud, Menu, X, Shield, Settings, Search as SearchIcon, Type } from "lucide-react";
...
const navigation = [
  ...
  { name: "Acronyms", href: "/settings/acronyms", icon: Type },
];
