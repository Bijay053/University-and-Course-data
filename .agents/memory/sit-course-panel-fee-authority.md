...
SIT’s Subjects, Fees & Scholarships international programme table is the catalogue-membership and course-data authority. Only exact programme matches or approved aliases are eligible. Use its Tuition Fee column, not Resource Fee or Total Fee, force NZD, and let its duration, intake, and English values override detail-page fallbacks.
