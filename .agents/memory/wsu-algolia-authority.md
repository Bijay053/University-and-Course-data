...
**How to apply:** Preserve configured Algolia metadata through discovery without URL caching, then merge it deterministically after page extraction. Use WSU’s official international English baseline only as a fill-only source, with title-matched nursing, allied-health, medicine, teaching, social-work, and psychology exceptions; do not treat valid bachelor titles containing “Pathway to Teaching” as preparatory programs.