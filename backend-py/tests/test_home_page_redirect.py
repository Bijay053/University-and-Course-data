...
def test_expand_merges_new_candidates(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    The fixture mocks ``bits`` (the first VIT brand slug, which is now
    probed first thanks to the brand-slugs-first ordering introduced
    to defeat the early-exit-starves-brand-slugs regression)."""
