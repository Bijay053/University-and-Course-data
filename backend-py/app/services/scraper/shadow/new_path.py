...
Initially (Phase 1 â harness validation): no transformation at all. The new
...
Adding a new uni transformation:
  ...
  3. Run shadow mode for 5 fresh scrapes (each â¥1 hour apart against live site).
...
async def extract_new_path(
    ...
    *,
    ...
    # Each block should only transform new_result["payload"] â leave url, name,
