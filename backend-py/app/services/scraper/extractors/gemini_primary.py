...
_HARD_FIELDS: dict[str, str] = {
    ...
    "location_text": (
        ...
        "(e.g. 'Melbourne', 'Sydney, Brisbane', 'Joondalup'). "
        "Use ONLY real city or campus names. "
        "If the page has an 'Availability & Campus' table with columns "
        "'Location | Semester 1 | Semester 2', the campus names are in the "
        "first column's data rows (e.g. 'Joondalup', 'Sri Lanka') — NOT the "
        "column headers. "
