...
_VISION_PROMPT: Final = (
    ...
    "per line, like:\n"
    "  International tuition fee: AUD $[amount] per year\n"
    "  IELTS overall: [band score from page]\n"
    "  IELTS listening: [band score from page]\n"
    "  PTE overall: [score from page]\n"
    "  TOEFL iBT: [score from page]\n"
    "Include currency symbols and units exactly as shown. "
    "CRITICAL: Only report values you can LITERALLY READ from the page "
    "pixels — do NOT invent, guess, or use typical defaults. "
    "If a value is not present, omit the line. "
    "Do NOT add commentary, headings, or markdown. Output only the lines, no preamble."
)
